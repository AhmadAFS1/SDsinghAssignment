...
php artisan serve                            <sub>// to run server 
php artisan tinker                           <sub>// tinker command used when obtaining data from database
User::all();                                 <sub>// used after using tinker command to get the user table data
QuoteHistory::all();                         <sub>// used after using tinker command to get QuoteHistory table data
